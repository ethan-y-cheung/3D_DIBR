...
def process_image(input_path: Path, output_dir: Path, depth_estimator: DepthEstimator, stereo_generator: StereoGenerator, inpainter: Inpainter):
    # UI stuff
    print(f"\n{'='*60}")
